...
const Header = () => {
  ...
  const particlesLoaded = useCallback(async (container) => {
    // Add any custom actions when particles are loaded if necessary
  }, []);
  ...
  return (
    <>
      <div style={{ position: 'relative', overflow: 'hidden' }}>
        <Particles
          ...
          options={{
            ...
            particles: {
              ...
              color: {
                value: '#ffcc00', // Gold color for particles
              },
              shape: {
                type: 'circle',
              },
              ...
              size: {
                value: 4, // Increase size slightly for better visibility
        ...
        />
        <Navbar collapseOnSelect expand="lg" className="navbarCSS" style={{
          position: 'relative', 
          zIndex: '2',
          background: 'linear-gradient(45deg, #1e3c72, #2a5298)', // Gradient for a stylish look
          boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2)', // Soft shadow for the navbar
        }}>
